#ifndef __GOOGLECRC_PORTABLE_H__
#define __GOOGLECRC_PORTABLE_H__

// This file was extracted and modified from 
// https://github.com/google/crc32c/blob/1c51f87c9ad8157b4461e2216b9272f13fd0be3b/src/crc32c_portable.cc
...
// LICENSE:
// https://github.com/google/crc32c/blob/1c51f87c9ad8157b4461e2216b9272f13fd0be3b/LICENSE
...
template <int N>
constexpr inline const uint8_t* RoundUp(const unsigned char* pointer) {
...
inline void RequestPrefetch(const unsigned char* address) {
#if defined(_MSC_VER)
...
CRC_EXPORT uint32_t crc32_impl(uint32_t crc, const unsigned char* data, size_t size) {
